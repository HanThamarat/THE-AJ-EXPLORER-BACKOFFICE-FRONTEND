...
import { packageNotInclude } from "@/app/types/package";
import { IoCheckmarkCircleOutline } from "react-icons/io5";
import { Dropdown, MenuProps } from "antd";
import { IoIosMore } from "react-icons/io";

interface NotIncludeListProps {
    value: packageNotInclude[],
    onChange?: (value: packageNotInclude[]) => void;
}

export default function NotIncludeList({
    value = [],
    onChange
}: NotIncludeListProps) {
    ...
    const handleAddWhatInclude = () => {
        ...
        const newWhatinclude: packageNotInclude = {
            detail: whatInclude
        };
